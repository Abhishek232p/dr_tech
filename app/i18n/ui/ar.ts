...
export const ui: UiDictionary = {
  meta: {
    title: "dr_tech — تعلَّم التشريح كما يفعل الفنان",
    description:
    ...
    ogTitle: "dr_tech — تعلَّم التشريح كما يفعل الفنان",
    ogDescription: "تعلَّم التشريح كما يفعل الفنان عبر عيّنات ثلاثية الأبعاد غنية بالتفاصيل الطبية.",
    imageAlt: "عيّنة قلب تشريحية تطفو فوق قاعدة، إلى جانب شعار dr_tech",
  },
  brand: { tagline: "تعلَّم التشريح كما يفعل الفنان", home: "الصفحة الرئيسية لـ dr_tech" },
