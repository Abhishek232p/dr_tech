...
export const ui: UiDictionary = {
  meta: {
    title: "dr_tech — учить анатомию как художник",
    description:
    ...
    ogTitle: "dr_tech — учить анатомию как художник",
    ogDescription: "Изучайте анатомию как художник — на подробных трёхмерных препаратах.",
    imageAlt: "Анатомический препарат сердца, парящий над подставкой, рядом с логотипом dr_tech",
  },
  brand: { tagline: "Учить анатомию как художник", home: "Главная страница dr_tech" },
