...
export const ui: UiDictionary = {
  meta: {
    title: "dr_tech — शरीर रचना, एक कलाकार की तरह",
    description:
    ...
    ogTitle: "dr_tech — शरीर रचना, एक कलाकार की तरह",
    ogDescription: "गहन, चिकित्सकीय रूप से विस्तृत 3D नमूनों के साथ शरीर रचना सीखें।",
    imageAlt: "एक चौकी पर तैरता शारीरिक हृदय, dr_tech के नाम-चिह्न के साथ",
  },
  brand: { tagline: "शरीर रचना, एक कलाकार की तरह", home: "dr_tech मुखपृष्ठ" },
