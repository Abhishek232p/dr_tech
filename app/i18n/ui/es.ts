...
export const ui: UiDictionary = {
  meta: {
    title: "dr_tech — Aprende anatomía como un artista",
    description:
    ...
    ogTitle: "dr_tech — Aprende anatomía como un artista",
    ogDescription: "Aprende anatomía como un artista con especímenes 3D inmersivos y médicamente detallados.",
    imageAlt: "Un corazón anatómico flotando sobre un pedestal, junto al logotipo de dr_tech",
  },
  brand: { tagline: "Aprende anatomía como un artista", home: "Inicio de dr_tech" },
