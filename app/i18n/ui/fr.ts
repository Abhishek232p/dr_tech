...
export const ui: UiDictionary = {
  meta: {
    title: "dr_tech — Apprendre l'anatomie comme un artiste",
    description:
    ...
    ogTitle: "dr_tech — Apprendre l'anatomie comme un artiste",
    ogDescription: "Apprenez l'anatomie comme un artiste grâce à des spécimens 3D immersifs et médicalement détaillés.",
    imageAlt: "Un cœur anatomique flottant au-dessus d'un socle, à côté du logotype dr_tech",
  },
  brand: { tagline: "Apprendre l'anatomie comme un artiste", home: "Accueil d'dr_tech" },
