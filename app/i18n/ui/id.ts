...
export const ui: UiDictionary = {
  meta: {
    title: "dr_tech — Belajar anatomi seperti seorang seniman",
    description:
    ...
    ogTitle: "dr_tech — Belajar anatomi seperti seorang seniman",
    ogDescription: "Pelajari anatomi seperti seorang seniman melalui spesimen 3D yang imersif dan detail secara medis.",
    imageAlt: "Spesimen jantung anatomis melayang di atas alas, di samping logo dr_tech",
  },
  brand: { tagline: "Belajar anatomi seperti seorang seniman", home: "Beranda dr_tech" },
