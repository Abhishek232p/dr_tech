...
export const ui: UiDictionary = {
  meta: {
    title: "dr_tech — Anatomie lernen wie ein Künstler",
    description:
    ...
    ogTitle: "dr_tech — Anatomie lernen wie ein Künstler",
    ogDescription: "Lerne Anatomie wie ein Künstler – mit immersiven, medizinisch detaillierten 3D-Präparaten.",
    imageAlt: "Ein anatomisches Herzpräparat über einem Sockel, daneben der Schriftzug dr_tech",
  },
  brand: { tagline: "Anatomie lernen wie ein Künstler", home: "Startseite von dr_tech" },
