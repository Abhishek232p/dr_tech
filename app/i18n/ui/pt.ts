...
export const ui: UiDictionary = {
  meta: {
    title: "dr_tech — Aprenda anatomia como um artista",
    description:
    ...
    ogTitle: "dr_tech — Aprenda anatomia como um artista",
    ogDescription: "Aprenda anatomia como um artista com espécimes 3D imersivos e ricos em detalhe médico.",
    imageAlt: "Um coração anatômico flutuando sobre um pedestal, ao lado da marca dr_tech",
  },
  brand: { tagline: "Aprenda anatomia como um artista", home: "Página inicial do dr_tech" },
